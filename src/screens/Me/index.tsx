...
function Me() {
  return (
    ...
    >
      ...
      >
        <h2 className="mb-2 w-fit border-b border-accent text-3xl font-bold sm:text-4xl lg:text-5xl 2xl:text-6xl md:portrait:text-5xl">
          me
        </h2>
        <p className="text-justify md:text-lg xl:text-xl 2xl:text-2xl">
          Hello! My name is Pedro Olavo, I&apos;m 18 years old and I have worked
          in the tech industry as a Software developer for a year. Ever since my
          early days I was deeply passionate about technology, and it has always
          been my dream to contribute to the upcoming changes in the world.
        </p>
      </motion.section>
      ...
      <motion.section
        ...
        variants={typographyAnimations}
      >
        <h2 className="mx-5 mb-4 w-fit border-b border-accent text-3xl font-bold text-white sm:text-4xl lg:text-5xl 2xl:text-6xl md:portrait:text-5xl">
          experience
        </h2>
